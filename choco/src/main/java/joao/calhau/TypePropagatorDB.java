...
public class TypePropagatorDB extends Propagator<SetVar> {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        try {
            ...
            con = DriverManager.getConnection("jdbc:h2:file:./db/" + folder + ";MVCC=FALSE;MV_STORE=FALSE;IFEXISTS=TRUE", "sa", "sa");
            ...
            System.out.println("Class not Found in type propagator");
